...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './acao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACAO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACAO actions', async () => {
      const expectedActions = [
        {
