...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CADASTROUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CADASTROUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CADASTROUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CADASTROUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CADASTROUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CADASTROUSER actions', async () => {
      const expectedActions = [
        {
