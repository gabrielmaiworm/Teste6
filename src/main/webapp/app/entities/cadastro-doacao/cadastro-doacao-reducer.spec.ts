...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CADASTRODOACAO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CADASTRODOACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CADASTRODOACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CADASTRODOACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CADASTRODOACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CADASTRODOACAO actions', async () => {
      const expectedActions = [
        {
